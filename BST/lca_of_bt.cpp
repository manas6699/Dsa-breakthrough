...
binary_tree_node<int> *lcaBinaryTreeHelper(binary_tree_node<int> *root, int a, int b)
{
    if (root == NULL)
    {
        return NULL;
    ...
    binary_tree_node<int> *left_lca = lcaBinaryTreeHelper(root->left, a, b);

    binary_tree_node<int> *right_lca = lcaBinaryTreeHelper(root->right, a, b);
...
int lcaBinaryTree(binary_tree_node<int> *root, int val1, int val2)
{

    binary_tree_node<int> *node = lcaBinaryTreeHelper(root, val1, val2);
    if (node != NULL)
    {
        return node->data;
    }
...
int main()
{
    ...
    cout << "Lca of the given node is : " << lcaBinaryTree(root, m, n);
    return 0;
}
