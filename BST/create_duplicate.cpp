...
void insertDuplicateNode(binary_tree_node<int> *root)
{
    if (root == NULL)
    {
        return;
    ...
    binary_tree_node<int> *newNode = new binary_tree_node<int>(root->data);

    binary_tree_node<int> *rootLeft = root->left;
    root->left = newNode;
