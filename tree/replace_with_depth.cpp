...
tree_node <int> *replace_with_depth(tree_node<int> *root ,int depth)
{
    ...
    {
        replace_with_depth(root->children.at(i) , depth + 1);
    }
...
int main()
{
    ...
    cout << "Depth map : " << endl;
    tree_node<int> *p1 = replace_with_depth(root , depth);
    print_tree(root);
    return 0;
}
